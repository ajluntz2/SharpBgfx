...
namespace SharpBgfx {
    ...
    public unsafe struct DynamicVertexBuffer : IDisposable, IEquatable<DynamicVertexBuffer> {
        ...
        public DynamicVertexBuffer (uint vertexCount, VertexLayout layout, BufferFlags flags = BufferFlags.None) {
        ...
        public void Update (uint startVertex, MemoryBlock memory) {
